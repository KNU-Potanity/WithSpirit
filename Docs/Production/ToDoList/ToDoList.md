...
- [x] `DUNGGEUNMO SDF` 폰트 출처 불명 문제 해결 완료 (2026-09-14) — 출처가 확인된 `NeoDunggeunmo`(neodgm.ttf, https://neodgm.dalgona.dev/)로 교체하고 `에셋_출처_라이선스_관리.md` 4장에 기록함 (`월드_스테이지_구성.md` 10.5절 참고)
