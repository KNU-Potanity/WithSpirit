...
- [ ] `스탯_기획서.md`의 (추후 확정) 항목에 실제 수치 채우기
- [ ] `월드_스테이지_구성.md` 2장 스토리 구체화 → 별도 문서(`Docs/Design/Story/스토리.md`) 분리
- [ ] 하트(체력) 최대 개수 확정
- [ ] 보스(밤 나무) 패턴 설계
...
- [ ] 정령 스프라이트/애니메이션 제작
- [ ] 몬스터 6종 + 보스 스프라이트/애니메이션 제작 (`아트스타일_가이드.md` 9.2절)
- [ ] 신규 발판 3종 타일/오브젝트 아트 제작 (`아트스타일_가이드.md` 9.3절)
- [ ] 마커/하트 UI 목업 제작 (`아트스타일_가이드.md` 9.4절)
