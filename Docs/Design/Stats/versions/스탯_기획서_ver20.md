...
> 마지막 수정일: 2026-08-04 (3.7절 막대 그래프를 3.6절 최신 수치에 맞춰 재계산 — ver20)
...
#### 나무 골렘 (TreeGolem) — 📝 제안 초안 (`GroundMonsterData`, 2026-08-04 수정)
...
#### 밤 나무 (Boss_Ent) — 📝 제안 초안 (전용 데이터 클래스 없음, `MonsterData` 기준, 2026-08-04 수정)
...
#### 식충식물 (CarnivorousPlant) — 📝 제안 초안 (`GroundMonsterData`, 2026-08-04 수정)
