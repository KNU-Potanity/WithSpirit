...
> 마지막 수정일: 2026-07-30 (3.6절 필드명에 한글 스탯 이름 병기 — ver6)
...
| Knockback (넉백) | 2 |
| Attack Anim Delay (공격 예비동작 딜레이) | 0.4 |
...
| Knockback (넉백) | 1.5 |
| Attack Anim Delay (공격 예비동작 딜레이) | 0.3 |
...
| Knockback (넉백) | 3 |
| Attack Anim Delay (공격 예비동작 딜레이) | 0.6 (덩치가 큰 만큼 예비동작도 느리게) |
| Min Horizontal Normal X (수평 벽 판정 기준값) | 0.9 |
...
| Knockback (넉백) | 2 |
| Attack Anim Delay (공격 예비동작 딜레이) | 0.35 |
| Min Horizontal Normal X (수평 벽 판정 기준값) | 0.9 |
...
| Knockback (넉백) | 2 |
| Attack Anim Delay (공격 예비동작 딜레이) | 0.5 (활 조준 시간) |
...
| Knockback (넉백) | 4 |
| Attack Anim Delay (공격 예비동작 딜레이) | 0.8 (거대한 몸집의 예비동작) |
