...
> 마지막 수정일: 2026-07-30 (3.7절을 코드블록 텍스트 막대에서 마크다운 표 형식으로 변경 — ver13)
...
### 3.7 몬스터 스탯 비교 차트 (2026-07-30 추가, 2026-07-30 표 형식으로 변경)

3.6절 수치를 한눈에 비교할 수 있도록 표로 정리했습니다. 표는 뷰어가 열 너비를 자동으로 맞춰주므로 이름 길이와 무관하게 막대 시작점이 항상 같은 위치에서 정렬됩니다. (막대 1칸의 실제 값은 항목마다 다르므로, 항목 내 몬스터끼리만 비교하세요.)
