...
| `MonsterData.cs` | `Assets/_Project/Scripts/ScriptableObjects/EnemyData/MonsterData.cs` | Health, MoveSpeed, Damage, CoolTime, AttackRangeX, AttackRangeY, DetectionRange, Knockback, AttackAnimDelay (2026-07-28: 공통 필드 확장) | `스탯_기획서.md` 3.1 공통 |
